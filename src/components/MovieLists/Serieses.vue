...
<nav-bar/>
    <div class="main-container" v-if="data">
        <u><h1>Currently Airing Tv Shows</h1></u>
...
import NavBar from "../NavBar"
    ...
    export default{
        ...
        methods: {
            async fetchdata(){
            const response = await fetch('https://api.themoviedb.org/3/tv/on_the_air?api_key=3990d54b09ed3c1179f3b38bd8567a99&adult=false&page=1')
            this.data = await response.json()
            },
            async GoNext(num){
            const response = await fetch(`https://api.themoviedb.org/3/tv/on_the_air?api_key=3990d54b09ed3c1179f3b38bd8567a99&adult=false&page=${num + 1}`)
            this.data = await response.json() 
            },
            async GoBack(num){
            const response = await fetch(`https://api.themoviedb.org/3/tv/on_the_air?api_key=3990d54b09ed3c1179f3b38bd8567a99&adult=false&page=${num - 1}`)
